...
module Homebrew
  ...
  def edit
    ...
    paths = [HOMEBREW_REPOSITORY] if Homebrew.args.named.empty?

    # Don't use Homebrew.args.formulae as that will throw if the file doesn't parse
    paths ||= Homebrew.args.named.map do |name|
