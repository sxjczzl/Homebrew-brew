...
HOMEBREW_BOTTLE_DEFAULT_MACOS_DOMAIN="https://homebrew.bintray.com"
HOMEBREW_BOTTLE_DEFAULT_LINUX_DOMAIN="https://linuxbrew.bintray.com"

if [[ -n "$HOMEBREW_MACOS" || -n "$HOMEBREW_FORCE_HOMEBREW_ON_LINUX" ]]
then
  HOMEBREW_BOTTLE_DEFAULT_DOMAIN="$HOMEBREW_BOTTLE_DEFAULT_MACOS_DOMAIN"
else
  HOMEBREW_BOTTLE_DEFAULT_DOMAIN="$HOMEBREW_BOTTLE_DEFAULT_LINUX_DOMAIN"
fi
...
export HOMEBREW_BOTTLE_DEFAULT_MACOS_DOMAIN
export HOMEBREW_BOTTLE_DEFAULT_LINUX_DOMAIN
