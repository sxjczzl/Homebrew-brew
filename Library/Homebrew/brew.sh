...
HOMEBREW_HOMEBREW_BOTTLE_DEFAULT_DOMAIN="https://ghcr.io/v2/homebrew/core"
HOMEBREW_LINUXBREW_BOTTLE_DEFAULT_DOMAIN="https://ghcr.io/v2/linuxbrew/core"
if [[ -n "${HOMEBREW_MACOS}" || -n "${HOMEBREW_FORCE_HOMEBREW_ON_LINUX}" ]]
then
  HOMEBREW_BOTTLE_DEFAULT_DOMAIN="${HOMEBREW_HOMEBREW_BOTTLE_DEFAULT_DOMAIN}"
else
  HOMEBREW_BOTTLE_DEFAULT_DOMAIN="${HOMEBREW_LINUXBREW_BOTTLE_DEFAULT_DOMAIN}"
fi
...
export HOMEBREW_HOMEBREW_BOTTLE_DEFAULT_DOMAIN
export HOMEBREW_LINUXBREW_BOTTLE_DEFAULT_DOMAIN
