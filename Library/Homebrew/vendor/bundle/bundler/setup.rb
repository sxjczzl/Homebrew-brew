...
$:.unshift "#{path}/../#{ruby_engine}/#{ruby_version}/gems/bindata-2.4.4/lib"
$:.unshift "#{path}/"
...
$:.unshift "#{path}/../#{ruby_engine}/#{ruby_version}/gems/elftools-1.1.1/lib"
...
$:.unshift "#{path}/../#{ruby_engine}/#{ruby_version}/extensions/x86_64-darwin-13/2.6.0-static/nokogiri-1.10.7"
...
$:.unshift "#{path}/../#{ruby_engine}/#{ruby_version}/gems/patchelf-0.1.0/lib"
