...
HOMEBREW_BOTTLE_DEFAULT_MACOS_DOMAIN = ENV["HOMEBREW_BOTTLE_DEFAULT_MACOS_DOMAIN"]
HOMEBREW_BOTTLE_DEFAULT_LINUX_DOMAIN = ENV["HOMEBREW_BOTTLE_DEFAULT_LINUX_DOMAIN"]
