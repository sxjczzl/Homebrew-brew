...
HOMEBREW_HOMEBREW_BOTTLE_DEFAULT_DOMAIN = ENV["HOMEBREW_HOMEBREW_BOTTLE_DEFAULT_DOMAIN"]
HOMEBREW_LINUXBREW_BOTTLE_DEFAULT_DOMAIN = ENV["HOMEBREW_LINUXBREW_BOTTLE_DEFAULT_DOMAIN"]
