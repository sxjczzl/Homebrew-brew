...
Before submitting a new formula make sure you read over our [contribution guidelines](../CONTRIBUTING.md).
...
Now, please [open a pull request](How-To-Open-a-Homebrew-Pull-Request-(and-get-it-merged).md#how-to-open-a-homebrew-pull-request-and-get-it-merged) for your changes.
