...
* `python` points to Homebrew's Python 2.7.x (if installed) otherwise the macOS system Python. Add `/usr/local/opt/python/libexec/bin` into your PATH if you wish to add Homebrew's 3.x `python` to your `PATH`.
